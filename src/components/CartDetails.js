...
{
carts.length>0?<button className='btn btn-danger mt-0 btn-sm' onClick={emptycart}><i className='fa fa-trash-alt mr-2'></i><span>EmptyCart</span></button>
:""
}
</div>
</div>
...
<td>
    ...
    <div className='product-img'><img src={data.imgdata} alt=""/></div></td>
